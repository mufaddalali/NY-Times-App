    ...
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-2 py-8 mx-auto">
          ...
          <div className="">
      <span data-testid="todays-date">{currentDate}</span>
    </div>
            </div>
          ...
          <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
           <input type="text" id="full-name" value={searchQuery}
        onChange={handleSearchChange} placeholder="Search Article" name="full-name" className="w-2/3 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          ...
          <Router>
        <Routes>
        <Route path="/" element={<Article articles={filteredData} />} />
